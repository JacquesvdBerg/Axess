                ...
                response.forEach(function (item) {
                    ...
                    var row = `
                        <tr id="${ID}" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                            ...
                            <td>
                            <a href="#" class="font-medium text-blue-600 dark:text-blue-500 hover:underline" onclick="deny_user(event, '${ID}')">Deny</a>
                            </td>
                        </tr>
                    `;
...
function deny_user(event, ID) {
    event.preventDefault();
    // Implement the remove_user() function logic here
    // Create a new XHR object
    console.log("ID that got denied:", ID);
    var xhttp = new XMLHttpRequest();
    ...
    // Open the request
    xhttp.open('POST', 'deny_user.php', true);
